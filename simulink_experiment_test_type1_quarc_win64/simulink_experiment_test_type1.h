/*
 * simulink_experiment_test_type1.h
 *
...
#ifndef RTW_HEADER_simulink_experiment_test_type1_h_
#define RTW_HEADER_simulink_experiment_test_type1_h_
#ifndef simulink_experiment_test_type1_COMMON_INCLUDES_
#define simulink_experiment_test_type1_COMMON_INCLUDES_
#include "rtwtypes.h"
#include "simstruc.h"
...
#endif                     /* simulink_experiment_test_type1_COMMON_INCLUDES_ */

#include "simulink_experiment_test_type1_types.h"
...
#define simulink_experiment_test_type1_rtModel RT_MODEL_simulink_experiment__T

/* Block signals (default storage) */
typedef struct {
  real_T HILReadEncoderTimebase;       /* '<S1>/HIL Read Encoder Timebase' */
  real_T HILReadAnalog;                /* '<S1>/HIL Read Analog' */
  real_T BB01SensorGainmV;             /* '<S1>/BB01 Sensor  Gain (m//V)' */
  real_T Positionbias;                 /* '<S1>/Position bias' */
  real_T EncoderCalibrationradcount;
                                  /* '<S1>/Encoder Calibration  (rad//count)' */
  real_T Bias;                         /* '<S1>/Bias' */
  real_T MotorGainVV;                  /* '<S1>/Motor  Gain (V//V)' */
  real_T mtocm;                        /* '<Root>/m to cm' */
  real_T Gain;                         /* '<S2>/Gain' */
} B_simulink_experiment_test_ty_T;
...
} DW_simulink_experiment_test_t_T;

/* Backward compatible GRT Identifiers */
#define rtB                            simulink_experiment_test_type_B
#define BlockIO                        B_simulink_experiment_test_ty_T
#define rtP                            simulink_experiment_test_type_P
#define Parameters                     P_simulink_experiment_test_ty_T
#define rtDWork                        simulink_experiment_test_typ_DW
#define D_Work                         DW_simulink_experiment_test_t_T

/* Parameters (default storage) */
struct P_simulink_experiment_test_ty_T_ {
  ...
  real_T HILInitialize_POWatchdog;     /* Expression: watchdog_pwm_outputs
                                        * Referenced by: '<S1>/HIL Initialize'
                                        */
  real_T BB01SensorGainmV_Gain;        /* Expression: -16.75/10*0.0254
                                        * Referenced by: '<S1>/BB01 Sensor  Gain (m//V)'
                                        */
  real_T Positionbias_Bias;            /* Expression: 0
                                        * Referenced by: '<S1>/Position bias'
                                        */
  real_T EncoderCalibrationradcount_Gain;/* Expression: 2*pi/4096
                                          * Referenced by: '<S1>/Encoder Calibration  (rad//count)'
                                          */
  real_T Bias_Bias;                    /* Expression: -56*pi/180
                                        * Referenced by: '<S1>/Bias'
                                        */
  real_T Constant_Value;               /* Expression: 0
                                        * Referenced by: '<Root>/Constant'
                                        */
  real_T MotorGainVV_Gain;             /* Expression: -1
...
struct tag_RTM_simulink_experiment_t_T {
  const char_T *path;
...
extern P_simulink_experiment_test_ty_T simulink_experiment_test_type_P;

/* Block signals (default storage) */
extern B_simulink_experiment_test_ty_T simulink_experiment_test_type_B;

/* Block states (default storage) */
extern DW_simulink_experiment_test_t_T simulink_experiment_test_typ_DW;

/* Model entry point functions */
extern void simulink_experiment_test_type1_initialize(void);
extern void simulink_experiment_test_type1_output(void);
extern void simulink_experiment_test_type1_update(void);
extern void simulink_experiment_test_type1_terminate(void);

/*====================*
 * External functions *
 *====================*/
extern simulink_experiment_test_type1_rtModel *simulink_experiment_test_type1
  (void);
...
extern RT_MODEL_simulink_experiment__T *const simulink_experiment_test_typ_M;
 ...
 *
 * '<Root>' : 'simulink_experiment_test_type1'
 * '<S1>'   : 'simulink_experiment_test_type1/Ball and Beam Hardware Interface'
 * '<S2>'   : 'simulink_experiment_test_type1/Radians to Degrees'
 */
#endif                        /* RTW_HEADER_simulink_experiment_test_type1_h_ */
