/*
 * simulink_experiment_debug_type1.h
 *
...
#ifndef RTW_HEADER_simulink_experiment_debug_type1_h_
#define RTW_HEADER_simulink_experiment_debug_type1_h_
#ifndef simulink_experiment_debug_type1_COMMON_INCLUDES_
#define simulink_experiment_debug_type1_COMMON_INCLUDES_
#include "rtwtypes.h"
#include "simstruc.h"
...
#define simulink_experiment_debug_type1_rtModel RT_MODEL_simulink_experiment__T
...
typedef struct {
  ...
  real_T MATLABSystem_o6;              /* '<Root>/MATLAB System' */
...
typedef struct {
  ...
  struct {
    void *LoggedData[2];
  } est_ball_pos_PWORK;                /* '<Root>/est_ball_pos' */

  struct {
    void *LoggedData[2];
  } est_ball_vel_PWORK;                /* '<Root>/est_ball_vel' */

  struct {
    void *LoggedData[2];
  } est_beam_ang_PWORK;                /* '<Root>/est_beam_ang' */
 ...
 * External functions *
 *====================*/
extern simulink_experiment_debug_type1_rtModel *simulink_experiment_debug_type1
  (void);
 ...
 *
 * '<Root>' : 'simulink_experiment_debug_type1'
 * '<S1>'   : 'simulink_experiment_debug_type1/Ball and Beam Hardware Interface'
 * '<S2>'   : 'simulink_experiment_debug_type1/MATLAB Function'
 * '<S3>'   : 'simulink_experiment_debug_type1/Radians to Degrees'
 */
#endif                       /* RTW_HEADER_simulink_experiment_debug_type1_h_ */
