...
## Generated on : Wed Apr 23 12:40:48 2025
...
PRODUCT_NAME              = simulink_experiment_debug_type1
MAKEFILE                  = simulink_experiment_debug_type1.mk
MATLAB_ROOT               = C:\PROGRA~1\MATLAB\R2022b
MATLAB_BIN                = C:\PROGRA~1\MATLAB\R2022b\bin
MATLAB_ARCH_BIN           = $(MATLAB_BIN)\win64
START_DIR                 = \\fileservice1\sp25\emily_lukas\Documents\MATLAB\EE222-Nonlinear-Systems-Ball-and-Beam-Project-main\models
SOLVER                    = 
SOLVER_OBJ                = 
CLASSIC_INTERFACE         = 1
TGT_FCN_LIB               = None
...
COMPILER_COMMAND_FILE     = simulink_experiment_debug_type1_comp.rsp
CMD_FILE                  = simulink_experiment_debug_type1.rsp
C_STANDARD_OPTS           = 
CPP_STANDARD_OPTS         = 
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)\simulink_experiment_debug_type1.rt-win64
...
SRCS = $(START_DIR)\simulink_experiment_debug_type1_quarc_win64\rtGetInf.c $(START_DIR)\simulink_experiment_debug_type1_quarc_win64\rtGetNaN.c $(START_DIR)\simulink_experiment_debug_type1_quarc_win64\rt_nonfinite.c $(START_DIR)\simulink_experiment_debug_type1_quarc_win64\simulink_experiment_debug_type1.c $(START_DIR)\simulink_experiment_debug_type1_quarc_win64\simulink_experiment_debug_type1_data.c $(START_DIR)\simulink_experiment_debug_type1_quarc_win64\simulink_experiment_debug_type1_main.c $(MATLAB_ROOT)\rtw\c\src\rt_sim.c C:\PROGRA~1\Quanser\QUARC\quarc\src\ext_svr.c C:\PROGRA~1\Quanser\QUARC\quarc\src\updown.c C:\PROGRA~1\Quanser\QUARC\quarc\src\ext_work.c
...
OBJS = rtGetInf.obj rtGetNaN.obj rt_nonfinite.obj simulink_experiment_debug_type1.obj simulink_experiment_debug_type1_data.obj simulink_experiment_debug_type1_main.obj rt_sim.obj ext_svr.obj updown.obj ext_work.obj
...
{$(START_DIR)\simulink_experiment_debug_type1_quarc_win64}.c.obj :
	$(CC) $(CFLAGS) -Fo"$@" "$<"


{$(START_DIR)\simulink_experiment_debug_type1_quarc_win64}.cpp.obj :
	$(CPP) $(CPPFLAGS) -Fo"$@" "$<"
...
rtGetInf.obj : "$(START_DIR)\simulink_experiment_debug_type1_quarc_win64\rtGetInf.c"
	$(CC) $(CFLAGS) -Fo"$@" "$(START_DIR)\simulink_experiment_debug_type1_quarc_win64\rtGetInf.c"


rtGetNaN.obj : "$(START_DIR)\simulink_experiment_debug_type1_quarc_win64\rtGetNaN.c"
	$(CC) $(CFLAGS) -Fo"$@" "$(START_DIR)\simulink_experiment_debug_type1_quarc_win64\rtGetNaN.c"


rt_nonfinite.obj : "$(START_DIR)\simulink_experiment_debug_type1_quarc_win64\rt_nonfinite.c"
	$(CC) $(CFLAGS) -Fo"$@" "$(START_DIR)\simulink_experiment_debug_type1_quarc_win64\rt_nonfinite.c"


simulink_experiment_debug_type1.obj : "$(START_DIR)\simulink_experiment_debug_type1_quarc_win64\simulink_experiment_debug_type1.c"
	$(CC) $(CFLAGS) -Fo"$@" "$(START_DIR)\simulink_experiment_debug_type1_quarc_win64\simulink_experiment_debug_type1.c"


simulink_experiment_debug_type1_data.obj : "$(START_DIR)\simulink_experiment_debug_type1_quarc_win64\simulink_experiment_debug_type1_data.c"
	$(CC) $(CFLAGS) -Fo"$@" "$(START_DIR)\simulink_experiment_debug_type1_quarc_win64\simulink_experiment_debug_type1_data.c"


simulink_experiment_debug_type1_main.obj : "$(START_DIR)\simulink_experiment_debug_type1_quarc_win64\simulink_experiment_debug_type1_main.c"
	$(CC) $(CFLAGS) -Fo"$@" "$(START_DIR)\simulink_experiment_debug_type1_quarc_win64\simulink_experiment_debug_type1_main.c"
