 ...
 * External functions *
 *====================*/
EXTERN RT_MODEL * simulink_experiment_debug_type1(void);
  ...
  main(int argc, char * argv[])
{
  ...
  if (parseError) {
    (void) fprintf(stderr,
                   "\nUsage: simulink_experiment_debug_type1 -option1 val1 -option2 val2 -option3 ...\n\n");
    (void) fprintf(stderr,
   ...
   ************************/
  S = simulink_experiment_debug_type1();
  if (rtmGetErrorStatus(S) != NULL) {
