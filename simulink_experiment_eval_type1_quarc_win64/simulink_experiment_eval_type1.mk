###########################################################################
## Makefile generated for component 'simulink_experiment_eval_type1'. 
## 
## Makefile     : simulink_experiment_eval_type1.mk
## Generated on : Wed Apr 09 13:35:28 2025
## Final product: $(RELATIVE_PATH_TO_ANCHOR)\simulink_experiment_eval_type1.rt-win64
...
PRODUCT_NAME              = simulink_experiment_eval_type1
MAKEFILE                  = simulink_experiment_eval_type1.mk
...
COMPILER_COMMAND_FILE     = simulink_experiment_eval_type1_comp.rsp
CMD_FILE                  = simulink_experiment_eval_type1.rsp
C_STANDARD_OPTS           = 
CPP_STANDARD_OPTS         = 
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)\simulink_experiment_eval_type1.rt-win64
...
DEFINES_STANDARD = -DMODEL=simulink_experiment_eval_type1 -DNUMST=3 -DNCSTATES=0 -DHAVESTDIO -DRT -DUSE_RTMODEL
...
SRCS = $(START_DIR)\simulink_experiment_eval_type1_quarc_win64\rtGetInf.c $(START_DIR)\simulink_experiment_eval_type1_quarc_win64\rtGetNaN.c $(START_DIR)\simulink_experiment_eval_type1_quarc_win64\rt_nonfinite.c $(START_DIR)\simulink_experiment_eval_type1_quarc_win64\simulink_experiment_eval_type1.c $(START_DIR)\simulink_experiment_eval_type1_quarc_win64\simulink_experiment_eval_type1_data.c $(START_DIR)\simulink_experiment_eval_type1_quarc_win64\simulink_experiment_eval_type1_main.c $(MATLAB_ROOT)\rtw\c\src\rt_sim.c C:\PROGRA~1\Quanser\QUARC\quarc\src\ext_svr.c C:\PROGRA~1\Quanser\QUARC\quarc\src\updown.c C:\PROGRA~1\Quanser\QUARC\quarc\src\ext_work.c
...
OBJS = rtGetInf.obj rtGetNaN.obj rt_nonfinite.obj simulink_experiment_eval_type1.obj simulink_experiment_eval_type1_data.obj simulink_experiment_eval_type1_main.obj rt_sim.obj ext_svr.obj updown.obj ext_work.obj
...
{$(START_DIR)\simulink_experiment_eval_type1_quarc_win64}.c.obj :
	$(CC) $(CFLAGS) -Fo"$@" "$<"


{$(START_DIR)\simulink_experiment_eval_type1_quarc_win64}.cpp.obj :
	$(CPP) $(CPPFLAGS) -Fo"$@" "$<"
...
rtGetInf.obj : "$(START_DIR)\simulink_experiment_eval_type1_quarc_win64\rtGetInf.c"
	$(CC) $(CFLAGS) -Fo"$@" "$(START_DIR)\simulink_experiment_eval_type1_quarc_win64\rtGetInf.c"


rtGetNaN.obj : "$(START_DIR)\simulink_experiment_eval_type1_quarc_win64\rtGetNaN.c"
	$(CC) $(CFLAGS) -Fo"$@" "$(START_DIR)\simulink_experiment_eval_type1_quarc_win64\rtGetNaN.c"


rt_nonfinite.obj : "$(START_DIR)\simulink_experiment_eval_type1_quarc_win64\rt_nonfinite.c"
	$(CC) $(CFLAGS) -Fo"$@" "$(START_DIR)\simulink_experiment_eval_type1_quarc_win64\rt_nonfinite.c"


simulink_experiment_eval_type1.obj : "$(START_DIR)\simulink_experiment_eval_type1_quarc_win64\simulink_experiment_eval_type1.c"
	$(CC) $(CFLAGS) -Fo"$@" "$(START_DIR)\simulink_experiment_eval_type1_quarc_win64\simulink_experiment_eval_type1.c"


simulink_experiment_eval_type1_data.obj : "$(START_DIR)\simulink_experiment_eval_type1_quarc_win64\simulink_experiment_eval_type1_data.c"
	$(CC) $(CFLAGS) -Fo"$@" "$(START_DIR)\simulink_experiment_eval_type1_quarc_win64\simulink_experiment_eval_type1_data.c"


simulink_experiment_eval_type1_main.obj : "$(START_DIR)\simulink_experiment_eval_type1_quarc_win64\simulink_experiment_eval_type1_main.c"
	$(CC) $(CFLAGS) -Fo"$@" "$(START_DIR)\simulink_experiment_eval_type1_quarc_win64\simulink_experiment_eval_type1_main.c"
